...
//    }
    ...
    public ResponseEntity<?> PaypalPaymentSucceded(@RequestBody TransactionHistoryDto request) {
    ...
    @GetMapping("/GetAll/TransactionHistory")
    public ResponseEntity<?> GetAllTransactionHistory() {
        return ResponseEntity.ok(clinetAccountService.GetAllTransactionHistory());
    }

    @GetMapping("/GetOne/TransactionHistory/{Transatction_Id}")
    public ResponseEntity<?> GetOneTransactionHistory(@PathVariable Integer Transatction_Id) {
        return ResponseEntity.ok(clinetAccountService.GetOneTransactionHistory(Transatction_Id));
    }
